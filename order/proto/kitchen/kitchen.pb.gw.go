...
/*
Package kitchen is a reverse proxy.
...
func request_KitchenService_ProcessOrder_0(ctx context.Context, marshaler runtime.Marshaler, client KitchenServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq order.Order
...
func local_request_KitchenService_ProcessOrder_0(ctx context.Context, marshaler runtime.Marshaler, server KitchenServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq order.Order
	var metadata runtime.ServerMetadata
...
func request_KitchenService_ChangeOrderStatus_0(ctx context.Context, marshaler runtime.Marshaler, client KitchenServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq order.ChangeOrderStatusRequest
	var metadata runtime.ServerMetadata
...
func local_request_KitchenService_ChangeOrderStatus_0(ctx context.Context, marshaler runtime.Marshaler, server KitchenServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq order.ChangeOrderStatusRequest
	var metadata runtime.ServerMetadata
...
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterKitchenServiceHandlerFromEndpoint instead.
func RegisterKitchenServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server KitchenServiceServer) error {

	mux.Handle("POST", pattern_KitchenService_ProcessOrder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_KitchenService_ProcessOrder_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_KitchenService_ProcessOrder_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("PUT", pattern_KitchenService_ChangeOrderStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_KitchenService_ChangeOrderStatus_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_KitchenService_ChangeOrderStatus_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterKitchenServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client KitchenServiceClient) error {
	...
	mux.Handle("POST", pattern_KitchenService_ProcessOrder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_KitchenService_ProcessOrder_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("PUT", pattern_KitchenService_ChangeOrderStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_KitchenService_ChangeOrderStatus_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	forward_KitchenService_ProcessOrder_0 = runtime.ForwardResponseMessage

	forward_KitchenService_ChangeOrderStatus_0 = runtime.ForwardResponseMessage
)
