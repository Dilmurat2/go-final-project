...
//
//	mockgen -source=D:\Programming\Projects\GOPROJECTS\INF-368-FINAL\order\internal\ports\services.go -destination=tests\mocks\services_mock -package=mocks
//
...
// MockOrderService is a mocks of OrderService interface.
type MockOrderService struct {
	ctrl     *gomock.Controller
	recorder *MockOrderServiceMockRecorder
}

// MockOrderServiceMockRecorder is the mocks recorder for MockOrderService.
type MockOrderServiceMockRecorder struct {
	mock *MockOrderService
}

// NewMockOrderService creates a new mocks instance.
...
// MockKitchenServiceClientProxy is a mocks of KitchenServiceClientProxy interface.
type MockKitchenServiceClientProxy struct {
	ctrl     *gomock.Controller
	recorder *MockKitchenServiceClientProxyMockRecorder
}

// MockKitchenServiceClientProxyMockRecorder is the mocks recorder for MockKitchenServiceClientProxy.
type MockKitchenServiceClientProxyMockRecorder struct {
	mock *MockKitchenServiceClientProxy
}

// NewMockKitchenServiceClientProxy creates a new mocks instance.
