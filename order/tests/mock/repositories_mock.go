...
//
//	mockgen -source=D:\Programming\Projects\GOPROJECTS\INF-368-FINAL\order\internal\ports\repostories.go -destination=tests\mock\orderRepository_mock -package=mock OrderRepository
//
